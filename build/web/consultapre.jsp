    ...
    <body data-spy="scroll" data-target=".navbar" data-offset="40" id="home">
        ...
        <div id="content">
            ...
            <div class="container">
                ...
                <div class="row">
                    <%
                        ArrayList<Venta> listaprepa = (ArrayList<Venta>) request.getAttribute("listaprepa");
                        for (Venta v : listaprepa) {
                    ...
                    <div class="card shadow mb-4">
                        ...
                        <a href="#collapseCardExample<%= v.getCodigoVenta()%>" class="d-block card-header py-3" data-toggle="collapse"
                           role="button" aria-expanded="true" aria-controls="collapseCardExample">
                             <h6 class="m-0 font-weight-bold text-succes">Estado  &nbsp; PREPARACIÓN</h6>
